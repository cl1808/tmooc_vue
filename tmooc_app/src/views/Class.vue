...
<style scoped>
  ...
  .container_box .content_box .java{
    background: url("../../public/img/class/fangxiang2.png") no-repeat;
  }
  ...
  .container_box .content_box .UID{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -173px;
  }
  .container_box .content_box .account{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -345px;
  }
  .container_box .content_box .c{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -518px;
  }
  .container_box .content_box .android{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -689px;
  }
  .container_box .content_box .net{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -861px;
  }
  .container_box .content_box .ios{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -1033px;
  }
  .container_box .content_box .php{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -1204px;
  }
  .container_box .content_box .Flushbonading{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -1378px;
  }
  .container_box .content_box .test{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -1549px;
  }
  .container_box .content_box .linux{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -1721px;
  }
  .container_box .content_box .market{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -1893px;
  }
  .container_box .content_box .unity{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -2065px;
  }
  .container_box .content_box .web{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -2237px;
  }
  .container_box .content_box .UI{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -2408px;
  }
  .container_box .content_box .data{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -2579px;
  }
  .container_box .content_box .UCD{
    background: url("../../public/img/class/fangxiang2.png") no-repeat 0 -2750px;
  }
  .container_box .content_box .AID{
    background: url("../../public/img/class/AID-ICON.png") no-repeat;
  }
  .container_box .content_box .CGB{
    background: url("../../public/img/class/icon2018070614lty.png") no-repeat;
  }
</style>